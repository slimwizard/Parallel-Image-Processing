...
#added for distributed inception v1
from nets.inception_v1_dist import inception_v1_dist
from nets.inception_v1_dist import inception_v1_dist_arg_scope
from nets.inception_v1_dist import inception_v1_dist_base
